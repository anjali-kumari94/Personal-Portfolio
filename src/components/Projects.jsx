...
const Projects = ({ onSectionChange }) => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "An AI-powered multilingual chatbot that automatically detects a user’s language and generates seamless, context- aware responses in English and multiple Indian languages.",
      technologies: [
        "React vite",
        "Python",
        "MongoDB",
