...
const Hero = ({ onSectionChange }) => {
  ...
  const animatedTexts = ["Web Applications", "Cloud-Native Solutions", "3D Experiences"];
      ...
      <div className="container-custom relative z-10 px-4 sm:px-0">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <h2 className="text-base sm:text-lg md:text-2xl text-gray-300 mb-2">
              Full Stack Developer | Cloud Enthusiast
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-400 max-w-[90vw] sm:max-w-2xl mx-auto">
              Building modern, scalable digital experiences using React,
              Node.js, MongoDB, and Cloud DevOps.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-10 h-6 sm:h-8 md:h-10 relative overflow-hidden text-primary-400 text-sm sm:text-lg font-semibold"
          >
            <motion.div
          ...
          >
            <motion.button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-lg font-semibold flex items-center justify-center space-x-2 hover:shadow-lg hover:shadow-primary-500/25 transition-all duration-300"
            >
          ...
          >
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                className="p-3 sm:p-4 rounded-full bg-white/10 hover:bg-primary-500/20 border border-white/20 hover:border-primary-500/50 transition-all duration-300"
              >
